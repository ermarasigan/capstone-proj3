...
(function($){
  $(function(){
    ...
    $('.newBlogBtn').click(function(){
      ...
      if(typeof title == 'undefined' || typeof content == 'undefined' || title == '' || content == ''){
        Materialize.toast('Missing input',2000)
      } else {
    ...
    $('.shareBtn').click(function(){
      Materialize.toast('FB share to be added in upcoming patch',2000)
    });
